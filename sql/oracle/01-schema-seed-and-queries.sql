...
CREATE TABLE Dom (
    ...
    Powierzchnia_Calkowita integer  NOT NULL,
    Ilosc_Pieter integer  NOT NULL,
    Obecnosc_garazu char(1)  NOT NULL,
    Koszt_Utrzymania integer  NOT NULL,
    Cena_rynkowa integer  NOT NULL,
...
CREATE TABLE Najemca (
    Osoba_Pesel integer  NOT NULL,
    Przyczyna_najmu varchar2(30)  NOT NULL,
...
CREATE TABLE Przestrzen (
    ID_Przestrzen integer  NOT NULL,
    Powierzchnia integer  NOT NULL,
    Lokalizacja varchar2(20)  NOT NULL,
    Wlasciciel_Osoba_Pesel integer  NOT NULL,
...
CREATE TABLE Umowa_o_wynajem (
    ...
    Najemca_Pesel integer  NOT NULL,
    Agent_nieruchomosci_Pesel integer  NULL,
    Dom_ID_Domu integer  NOT NULL,
...
-- Reference: Dom_Nieruchomosc (table: Dom)
ALTER TABLE Dom ADD CONSTRAINT Dom_Nieruchomosc
...
-- Reference: Nieruchomosc_Wlasciciel (table: Przestrzen)
ALTER TABLE Przestrzen ADD CONSTRAINT Nieruchomosc_Wlasciciel
    FOREIGN KEY (Wlasciciel_Osoba_Pesel)
    REFERENCES Wlasciciel (Osoba_Pesel);

-- Reference: Umowa_Agent_nieruchomosci (table: Umowa_o_wynajem)
ALTER TABLE Umowa_o_wynajem ADD CONSTRAINT Umowa_Agent_nieruchomosci
...
VALUES (1, 2500, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 34567890123, NULL, 1);
INSERT INTO Umowa_o_wynajem (ID_Umowy, Cena_Wynajmu, Data_rozpoczecia, Data_zakonczenia, Najemca_Pesel, Agent_nieruchomosci_Pesel, Dom_ID_Domu)
VALUES (2, 2000, TO_DATE('2023-06-01', 'YYYY-MM-DD'), TO_DATE('2023-12-31', 'YYYY-MM-DD'), 45678901234, 56789012345, 2);
INSERT INTO Umowa_o_wynajem (ID_Umowy, Cena_Wynajmu, Data_rozpoczecia, Data_zakonczenia, Najemca_Pesel, Agent_nieruchomosci_Pesel, Dom_ID_Domu)
VALUES (3, 3000, TO_DATE('2024-02-01', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'), 89012345678, 56789012345, 3);
INSERT INTO Umowa_o_wynajem (ID_Umowy, Cena_Wynajmu, Data_rozpoczecia, Data_zakonczenia, Najemca_Pesel, Agent_nieruchomosci_Pesel, Dom_ID_Domu)
...
HAVING COUNT(u.ID_Umowy) > (SELECT COUNT(u2.ID_Umowy) FROM Umowa_o_wynajem u2
        JOIN Najemca n2 ON u2.Najemca_Pesel = n2.Osoba_Pesel
        JOIN Osoba o2 ON n2.Osoba_Pesel = o2.Pesel
        WHERE TO_CHAR(o2.Pesel) LIKE '%56789') AND AVG(u.Cena_Wynajmu) > 2000;
...
WHERE u.Cena_Wynajmu > (SELECT AVG(Cena_Wynajmu) FROM Umowa_o_wynajem);
...
JOIN Umowa_o_wynajem u ON n.Osoba_Pesel = u.Najemca_Pesel
GROUP BY o.Imie, o.Nazwisko
HAVING AVG(u.Cena_Wynajmu) > (SELECT AVG(Cena_Wynajmu) FROM Umowa_o_wynajem);
...
WHERE u.Cena_Wynajmu = (
 ...
 JOIN Przestrzen p2 ON d2.Nieruchomosc_ID = p2.ID_Przestrzen
 WHERE 
 p2.Wlasciciel_Osoba_Pesel = p.Wlasciciel_Osoba_Pesel);
...
HAVING COUNT(u.ID_Umowy) > (
 ...
 FROM (
  SELECT 
  COUNT(u2.ID_Umowy) AS liczba_umow
  FROM Umowa_o_wynajem u2
